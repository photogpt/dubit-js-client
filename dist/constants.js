...
exports.SUPPORTED_TO_LANGUAGES = exports.SUPPORTED_FROM_LANGUAGES = exports.SUPPORTED_TRANSLATOR_VERSIONS = void 0;
/**
 * An array of available translator versions.
 */
exports.SUPPORTED_TRANSLATOR_VERSIONS = [
    {
        label: "V1 (Flash)",
        version: "1",
    },
...
exports.SUPPORTED_FROM_LANGUAGES = [
    {
        langCode: "multi",
...
exports.SUPPORTED_TO_LANGUAGES = [
    {
        langCode: "af-ZA",
